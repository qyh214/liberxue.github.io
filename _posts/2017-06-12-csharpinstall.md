...
date:   2017-05-13
ascription: study
excerpt: "c#dbug的软件安装太多了，但是好多都是商业软件收费且不说界面和UI各种东西受控制，作为一个强迫症患者我决定自定义一个"
tag:
- c#
- 打包安装
- debug打包
...
- zip
comments: false
feature: https://scontent-sea1-1.cdninstagram.com/t51.2885-15/e35/18645541_1749068475383518_8221744762454016000_n.jpg
---
### 设置安装包参数和信息
...
先上个图：
![install](http://www.liberxue.com/upload-img/install.gif)
### 解压释放
```
